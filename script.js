...
const articles = {
  ...
  byron: {
    ...
    body: `
      <p class="credential-line"><strong>BBC qualification:</strong> <em>BSc in Vibes Valuation, Dignity Depreciation & Aggressive Snack Auditing</em>.</p><p>Byron Alexander Sikiotis will report live from the financial district, currently believed to be somewhere between the accommodation and the nearest shop.</p>
